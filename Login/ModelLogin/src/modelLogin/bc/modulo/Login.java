...
public class Login {
    ...
    public static String contextoInicial(LoginModuloImpl moduloAplicacion, String nick) {
        ...
        Object respuesta =
            moduloAplicacion.getBaseDML().ejecutaConsultaUnicoDato(SQL_CONTEXTO_INICIAL, new Object[] { nick });
        if (moduloAplicacion.getBaseDML().getMensaje() != null) {
    ...
    private static int crearTokenServidor(LoginModuloImpl moduloAplicacion, int idToken, String token,
        ...
        row.setAttribute(TokenServidorImpl.USUARIOPROGRAMA, Atributos.stringLargo(usuarioPrograma, "<NO APLICA>", 256));
    ...
    private static void auditarIngresosFallidos(LoginModuloImpl moduloAplicacion, String nick, String ip,
        ...
        int idAuditoria =
            moduloAplicacion.auditoria_crearAuditoria(moduloAplicacion.getBundle("mudulo.nombre", new Object[0]),
                                                      "validarUsuario()", "", usuarioPrograma);
