package com.aplicaciones13.reporte.worksheet.worksheet;
...
public class WorksheetEstadoCuenta {
     ...
     * Manejo de bundles.
     */
    protected Bundles bundles = BundleFactory.createBundle(ImpresionBaseElementos.NOMBRE_APLICACION);
    ...
    private void escribeTitulos(String nombreSocio, String noCuenta, String periodo, String saldoDisponible, String saldoBloquead, String saldoTotal) {
        ...
        this.hce.addValorCelda(0, 0, bundles.getString("txt_001_01"), HojaCalculoEngine.H1);
        this.hce.addValorCelda(0, 1, bundles.getString("txt_001_08"), HojaCalculoEngine.H3);
        this.hce.addValorCelda(0, 3, bundles.getString("txt_001_09"), HojaCalculoEngine.H1);

        this.hce.addValorCelda(0, 5, bundles.getString("txt_001_10"), HojaCalculoEngine.H2_LEFT);
        this.hce.addValorCelda(0, 6, bundles.getString("txt_001_11"), HojaCalculoEngine.H2_LEFT);
        this.hce.addValorCelda(0, 7, bundles.getString("txt_001_12"), HojaCalculoEngine.H2_LEFT);

        this.hce.addValorCelda(0, 8, bundles.getString("txt_001_28"), HojaCalculoEngine.H2_LEFT);
        this.hce.addValorCelda(0, 9, bundles.getString("txt_001_29"), HojaCalculoEngine.H2_LEFT);
        this.hce.addValorCelda(0, 10, bundles.getString("txt_001_30"), HojaCalculoEngine.H2_LEFT);
        this.hce.addValorCelda(0, 11, bundles.getString("txt_001_27"), HojaCalculoEngine.H2_LEFT);

        this.hce.addValorCelda(2, 5, nombreSocio, HojaCalculoEngine.P_STRONG);
        this.hce.addValorCelda(2, 6, bundles.getString("txt_001_13"), HojaCalculoEngine.P_STRONG);
        ...
        this.hce.addValorCelda(4, 13, bundles.getString("txt_001_14"), HojaCalculoEngine.H2);
        this.hce.addValorCelda(6, 13, bundles.getString("txt_001_15"), HojaCalculoEngine.H2);
        this.hce.addValorCelda(0, 14, bundles.getString("txt_001_16"), HojaCalculoEngine.H2);
        this.hce.addValorCelda(1, 14, bundles.getString("txt_001_17"), HojaCalculoEngine.H2);
        this.hce.addValorCelda(2, 14, bundles.getString("txt_001_18"), HojaCalculoEngine.H2);
        this.hce.addValorCelda(3, 14, bundles.getString("txt_001_19"), HojaCalculoEngine.H2);
        this.hce.addValorCelda(4, 14, bundles.getString("txt_001_20"), HojaCalculoEngine.H2);
        this.hce.addValorCelda(5, 14, bundles.getString("txt_001_21"), HojaCalculoEngine.H2);
        this.hce.addValorCelda(6, 14, bundles.getString("txt_001_22"), HojaCalculoEngine.H2);
        this.hce.addValorCelda(7, 14, bundles.getString("txt_001_23"), HojaCalculoEngine.H2);
        this.hce.addValorCelda(8, 14, bundles.getString("txt_001_24"), HojaCalculoEngine.H2);
        this.hce.addValorCelda(9, 14, bundles.getString("txt_001_25"), HojaCalculoEngine.H2);
        this.hce.addValorCelda(10, 14, bundles.getString("txt_001_26"), HojaCalculoEngine.H2);
    }
