package com.aplicaciones13.reporte.pdf;

import com.aplicaciones13.factory.BundleFactory;
import com.aplicaciones13.reporte.pdf.itext.compuestos.Form;
import com.aplicaciones13.reporte.pdf.itext.compuestos.Panel;
import com.aplicaciones13.reporte.pdf.itext.compuestos.Tabla;
import com.aplicaciones13.reporte.pdf.itext.imagen.Imagen;
import com.aplicaciones13.reporte.pdf.itext.imagen.ImagenCodigoQR;
import com.aplicaciones13.reporte.pdf.itext.presentacion.Espacio;
import com.aplicaciones13.reporte.pdf.itext.presentacion.Linea;
import com.aplicaciones13.reporte.pdf.itext.texto.Elemento;
import com.aplicaciones13.reporte.pdf.itext.texto.P;
import com.aplicaciones13.reporte.pdf.itext.texto.Titulo;
...
public class ImpresionBaseElementos {
     ...
     * Nombre aplicacion.
     */
    public static final String NOMBRE_APLICACION = "reporte";
    /**
     * Elemento para generar los bundles.
     */
    protected Bundles bundles = BundleFactory.createBundle(NOMBRE_APLICACION);
    ...
    public void imprimirElemento(int valor) {
        ...
        switch (valor) {
            ...
            case 7:
                ...
                break;
            default:
                log.error("elemento no exite {}", valor);
        }
    }
    ...
    public synchronized void elemento0() {
        ...
        getH3().setTexto(bundles.getString("txt_000_01"));
        getH3().escribir();
    }
    ...
    public synchronized void elemento1() {
        ...
        getH3().setTexto(bundles.getString("txt_000_02"));
        getH3().escribir();

        getForm().setListaTitulos(
                bundles.getString("txt_000_03"),
                bundles.getString("txt_000_04"),
                bundles.getString("txt_000_05"));
        getForm().setListaValores(getParametrosBusqueda().get("documentoCodigo"),
                getParametrosBusqueda().get("sitioWeb"),
                bundles.getString("txt_000_07", getParametrosBusqueda().get("documentoValidez")));
    ...
    public void imprimirAtentamente() {
        ...
        getP().setTexto(bundles.getString("txt_001_05",
                getParametrosBusqueda().get("documentoSucursal"),
                getParametrosBusqueda().get("fechaEmision")));
        getP().escribir();

        getEspacio().escribir(4);
        getP().setTexto(bundles.getString("txt_001_06"));
        getP().escribir();

        getP().setTexto(bundles.getString("txt_001_07"));
        getP().escribir();
    ...
    public synchronized void elemento2() {
        log.info("elemento 2 no sobrecargado");
    }
    ...
    public synchronized void elemento3() {
        log.info("elemento 3 no sobrecargado");
    }
    ...
    public synchronized void elemento30() {
        log.info("elemento 30 no sobrecargado");
    }
    ...
    public synchronized void elemento4() {
        log.info("elemento 4 no sobrecargado");
    }
    ...
    public synchronized void elemento5() {
        log.info("elemento 5 no sobrecargado");
    }
    ...
    public synchronized void elemento6() {
        log.info("elemento 6 no sobrecargado");
    }
    ...
    public synchronized void elemento7() {
        log.info("elemento 7 no sobrecargado");
    }
    ...
    /**
     * Clase para contener la posicion current dentro de la escritura del sistema.
     *
     * @author omargo33@gmail.com
     *
     */
