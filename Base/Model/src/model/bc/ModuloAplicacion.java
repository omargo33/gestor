  ...
  implements BundleInterface
{
  ...
  public ModuloAplicacion() {
    ...
    public ApplicationModuleImpl miThis() { return this; }
    ...
    public ApplicationModuleImpl miHijo() { return this; }
  ...
  public String getBundle(String llaveBundle, Object... parametros) {
    ...
    try {
        ...
        return String.format("<No Definido, %s llave no encontrada %s>", new Object[] { llaveBundle, this.resourceBundle
              .getBaseBundleName() });
    } 
  ...
  public boolean commitRollback(Object datoControl, String metodo) {
    ...
    try {
        ...
        Logger.getLogger("global")
          .log(Level.SEVERE, 
            getBundle("000001", new Object[] { String.valueOf(datoControl), getClass().getName(), metodo, ex }));
        estado = false;
    } 
      return estado;
  }
  ...
  public boolean rollback(Object datoControl, String metodo) {
    ...
    try {
        ...
        Logger.getLogger("global")
          .log(Level.SEVERE, 
            getBundle("000000", new Object[] { String.valueOf(datoControl), getClass().getName(), metodo, ex }));
        estado = false;
    } 
  ...
  public void errorMysql(int codigoError, String metodo) {
      if (codigoError != 0) {
        String mensajeError = getBundle("000004", new Object[] { metodo, "errorMysql", Integer.valueOf(codigoError) });
