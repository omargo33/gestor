  ...
  public class GeneradorIngreso
  {
    public static void main(String[] args) {
      ...
      String data = "http://192.168.1.7:" + puertoWebLogic + "/" + aplicacion + "/faces/LOG001?server=WLS12&token=" + accesoXML.code();
      ...
      data = "http://192.168.1.7:" + puertoGlass + "/" + aplicacion + "/faces/LOG001?server=GF5&token=" + accesoXML.code();
