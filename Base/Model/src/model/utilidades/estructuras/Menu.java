...
public class Menu {
    ...
    public Menu() {
        ...
        this.nombreMenu = "";
        this.taskFlow = "";
        this.taskFlowInformacion = "";

        this.crear = false;
        this.actualizar = false;
        this.borrar = false;
        this.verAuditoria = false;
    }

    public Menu(int idMenusPermisos, int orden, String nick, String indiceModulo, String nombreModulo, String contexto,
                int idMenu, String tipo, String indiceMenu, String nombreMenu, String taskFlow,
                String taskFlowInformacion, boolean crear, boolean actualizar, boolean borrar, boolean verAuditoria) {
    ...
    public int getIdMenusPermisos() {
        return this.idMenusPermisos;
    }


    public void setIdMenusPermisos(int idMenusPermisos) {
        this.idMenusPermisos = idMenusPermisos;
    }
    ...
    public boolean getVerAuditoria() {
        return this.verAuditoria;
    }


    public void setVerAuditoria(boolean verAuditoria) {
        this.verAuditoria = verAuditoria;
    }


    public String getTaskFlowInformacion() {
        return this.taskFlowInformacion;
    }
