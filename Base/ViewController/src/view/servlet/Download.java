...
@WebServlet(name = "Download", urlPatterns = {"/faces/Download"})
    ...
    extends HttpServlet
  {
    ...
    private void escribirEventoDescarga(int idArchivo, String user, ModuloImpl moduloImpl) { moduloImpl.base_archivoCrearEvento(idArchivo, "D", "Descarga de elemento", user, "/faces/Download"); }
    ...
    public class Archivo
    {
      ...
      public String getPathRelativo() { return this.pathRelativo; }
      ...
      public String getFullpath() { return (String.valueOf(getPathBase()) + String.valueOf(getPathRelativo())).trim(); }
    }
  }
