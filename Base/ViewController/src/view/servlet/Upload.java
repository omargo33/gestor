...
public class Upload extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (nombreArchivo == null || nombreArchivo.compareTo("") == 0) {
            ...
            urlRespuesta =
                String.format(this.URL,
                              new Object[] { "info",
                                             String.format("El archivo \"%s\" ha cargado satisfactoriamente",
                                                           new Object[] { nombreTruncado }) });
        } else {
            urlRespuesta =
                String.format(this.URL,
                              new Object[] { "error",
                                             String.format("El archivo \"%s\" No ha podido ser guardado",
                                                           new Object[] { nombreTruncado }) });
        }
    ...
    /**
     * Subir de acuerdo a la plataforma.
     *
     * @param datosRequest
     * @param nombreArchivo
     * @return
    ...
    private boolean subirPlataforma(DatosRequest datosRequest, String nombreArchivo) {
        ...
        try {
            ...
            fullPath =
                Archivo.creaDirectorio(pathBase, datosRequest.getAEsquema(), datosRequest.getATabla(), nombreRamdon);
            ...
            moduloImpl.base_archivoCrear(datosRequest.getIntIdGrupo(), nombreArchivo, nombreRamdon, extension,
                                         pathRelativo, largo, "Archivo Creado desde elemento base", datosRequest.
    ...
    /**
     * Metodo para redireccionar el sistema.
     *
     * @param datosRequest
     * @param response
     * @param URL
    ...
    public class DatosRequest {
        ...
        public String getParametrosURL() {
            return String.format("&aExtensiones=%s&nameUser=%s&aEsquema=%s&aTabla=%s&idGrupo=%s",
                                 new Object[] { this.aExtensiones, this.nameUser, this.aEsquema, this.aTabla,
                                                this.idGrupo });
        }


        public String getAExtensiones() {
            return this.aExtensiones;
        }
        ...
        public int getIntIdGrupo() {
            return Integer.parseInt(this.idGrupo);
        }
