...
public class CodigoDefinidoUsuario {
     ...
     * @return
     */
    public static int unMovimiento(AdministrativoModuloImpl moduloAplicacion, int idCodigoDefinidoUsuario,
                                   boolean arriba) {
     ...
     * @return
     */
    public static int ejecutarExtremos(AdministrativoModuloImpl moduloAplicacion, int idCodigoDefinidoUsuario,
                                       int ubicacion) {
